...
image_transport::Publisher leftpub, floorPub;
...
int main(int argc, char **argv)
{
	...
	while (g_bRosOK)
	{
		...
		int subnumber = leftSubnumber + laserscanSubnumber + floorSubnumber;
        ...
        if (floorSubnumber > 0)
		{
            publishimage(data.de_out, floorPub, "mono8", timestamp);
        }
